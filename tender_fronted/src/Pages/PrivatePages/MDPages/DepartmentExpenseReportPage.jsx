...
import { getDepartmentAggExpReportApi } from '../../../AppApis/ApiFunctions';
...
const DepartmentExpenseReportPage = () => {
  ...
  const fetchReport = (year, departmentId) => {
    ...
    getDepartmentAggExpReportApi(params).then(res => {
  ...
  return (
    <Box sx={{ minHeight: '100vh' }}>
      <CustomPageTitle title="Expense Aggregrated - Department Report" />
...
export default DepartmentExpenseReportPage;